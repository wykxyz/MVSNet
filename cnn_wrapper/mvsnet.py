...
class UNetDS2GN(Network):
    ...
    def setup(self):
        ...
        .conv(3, base_filter * 4, 1, biased=False, relu = False, name='conv10_2')
         # .relu()
         # .conv_gn(5, base_filter * 4, 2, center=True, scale=True, name='conv11_0')
         # .conv_gn(3, base_filter * 4, 1, center=True, scale=True, name='conv11_1')
         # .conv(3, base_filter * 4, 1, biased=False, relu=False, name='conv11_2')
         # .relu()
         # .conv_gn(5, base_filter * 4, 2, center=True, scale=True, name='conv12_0')
         # .conv_gn(3, base_filter * 4, 1, center=True, scale=True, name='conv12_1')
         # .conv(3, base_filter * 4, 1, biased=False, relu=False, name='conv12_2')
         )
...
class SNetDS2GN_1(Network):
    ...
    def setup(self):
        ...
        (self.feed('sconv0_2')
        .conv_bn(3, base_filter*2, 1,dilation_rate=5, center=True, scale=True, name="sconv2_2")
        .conv_bn(3, base_filter*2, 1,dilation_rate=1, center=True, scale=True,relu=True, name="sconv2_3")
        )
        (self.feed('sconv0_2')
        .conv_bn(3, base_filter*2, 1,dilation_rate=7, center=True, scale=True, name="sconv3_2")
        .conv_bn(3, base_filter*2, 1,dilation_rate=1, center=True, scale=True,relu=True, name="sconv3_3")
        )
